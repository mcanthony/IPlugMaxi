...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMaxi-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMaxi-AAX-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugMaxi.pkgproj"
